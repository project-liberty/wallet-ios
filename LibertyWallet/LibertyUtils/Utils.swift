...
class Utils: NSObject {
    ...
    @objc static func configureNavigationBar(){
        ...
        UINavigationBar.appearance().barTintColor = K.color.blue_r27g46b79
        UINavigationBar.appearance().tintColor = .white
        UINavigationBar.appearance().isTranslucent = false
        UINavigationBar.appearance().backgroundColor = K.color.blue_r27g46b79
    ...
    @objc static func showMailController(messageBody:String, delegate:MFMailComposeViewControllerDelegate) {
        if MFMailComposeViewController.canSendMail() {
            ...
            mail.setToRecipients(["martin@liberty-coin.com"])
            mail.setSubject("Logs IOS Liberty   ")
    ...
    @objc static func changeStatusBackgroundColor(color:UIColor = K.color.blue_r27g46b79){
